    ...
    <main>
        <div class="detail bg-fff ">
            <div class="flex jc-sb lh15">
                ...
                <p class="yellow"> <i class="f16">{{Number(film.grade).toFixed(1)}}</i> <span class="f12">分</span></p>
            </div>
...
export default {
    ...
    methods:{
     getdata(){
         let url=`http://132.232.94.151:3000/api/film/getDetail?filmId=${this.filmId}`
